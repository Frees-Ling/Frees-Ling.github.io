...
![image](https://vip.123pan.cn/1816365004/yk6baz03t0m000dc7vs13c55g619ne4eDIYPAqDzAIaOAcxvDdawDO==.png)
...
![image](https://vip.123pan.cn/1816365004/ymjew503t0m000dc7vorn2398dwe3xuaDIYPAqDzAIaOAcxvDdawDO==.png)
...
![image](https://vip.123pan.cn/1816365004/yk6baz03t0n000dc7vs2h2pw4r19v5z3DIYPAqDzAIaOAcxvDdawDO==.png)
...
> **_评估目标检测模型的综合指标，考虑了精确率和召回率在不同置信度阈值下的表现_**
...
![image](https://vip.123pan.cn/1816365004/yk6baz03t0l000dc7vs2h2pi5m19oqteDIYPAqDzAIaOAcxvDdawDO==.png)
> 图表解读：
> 模型在完全不筛选（置信度为 0）时，能检测到 76% 的目标，但只要稍微提高置信度，就几乎检测不到任何目标了。这说明模型对目标的区分能力很弱，大量低置信度的预测其实是噪声

![image](https://vip.123pan.cn/1816365004/ymjew503t0l000dc7vorn22vqbwdvgxoDIYPAqDzAIaOAcxvDdawDO==.png)
...
![image](https://vip.123pan.cn/1816365004/yk6baz03t0l000dc7vs2h2pl8b19p5c2DIYPAqDzAIaOAcxvDdawDO==.png)
> 图表解读：
> **数据**：归一化后，对角线值为 1.00
> **解读**：进一步确认了在这个测试集上，模型的分类准确率是 100%。但这是基于极小样本量得出的结论，不具备泛化能力

![image](https://vip.123pan.cn/1816365004/ymjew503t0n000dc7vorwvg872we7xnsDIYPAqDzAIaOAcxvDdawDO==.jpg)
> 图表解读
> 数据集非常小且单一，这是导致评估指标 “看起来很美” 但实际泛化能力差的根本原因

![image](https://vip.123pan.cn/1816365004/ymjew503t0l000dc7vos3lz7brweb4xqDIYPAqDzAIaOAcxvDdawDO==.png)
> 图表解读：
> 损失曲线
>
